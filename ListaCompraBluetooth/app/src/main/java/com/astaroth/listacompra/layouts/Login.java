...
public class Login extends Activity {
    ...
    public void anadir(){
        DialogFragment dialogoSeleccion = DialogoUsuario.newInstance(R.string.nuevo_usuario);
    ...
    public static class DialogoUsuario extends DialogFragment {
        ...
        private void guardar() {
            if (!pass.getText().toString().equals(pass2.getText().toString())) {
                ...
                ((Login)getActivity()).guardarUsuario(new Usuario(user.getText().toString(), pass.getText().toString(), mail.getText().toString(), 0));
