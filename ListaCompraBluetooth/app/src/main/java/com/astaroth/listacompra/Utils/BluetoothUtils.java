...
/**
 * Created by rperez on 16/02/2015.
 */
...
//    private static final UUID MY_UUID_INSECURE = UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    ...
    // Debugging
    public static final String TAG = "BluetoothCompra";
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        // device.getName() == mAdapter.getName()
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                ...
                Log.e(TAG, "AcceptThread constructor: listen() failed", e);
            }
            mmServerSocket = tmp;
        }
        ...
        @Override
        public void run() {
            Log.d(TAG, "AcceptThread run: BEGIN mAcceptThread" + this);
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    Log.e(TAG, "AcceptThread run. STATE_CONNECTED --> Could not close unwanted socket", e);
                                }
                                break;
                        }
                    }
        ...
        public void cancel() {
            Log.d(TAG, "AcceptThread cancel. Socket cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                Log.e(TAG, "AcceptThread cancel. Socket close() of server failed", e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            /*} catch (NoSuchMethodException e) {
                Log.e(TAG, "ConnectThread: create() failed. Not found method", e);
            } catch (IllegalAccessException | InvocationTargetException e) {
                Log.e(TAG, "ConnectThread: create() failed. Arguments no valid", e);*/
            }
            mmSocket = tmp;
        }

        public void run() {
            Log.i(TAG, "ConnectThread run. BEGIN mConnectThread to device:"+ mmDevice.getName());
            ...
            try {
                ...
                try {
                    ...
                    Log.e(TAG, "ConnectThread run. unable to close() " +
        ...
        public void cancel() {
            try {
                ...
                Log.e(TAG, "ConnectThread cancel. close() of connect socket failed", e);
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            Log.i(TAG, "ConnectedThread run. BEGIN mConnectedThread");
        ...
        public void write(byte[] buffer) {
            try {
                Log.e(TAG, "ConnectedThread write");
