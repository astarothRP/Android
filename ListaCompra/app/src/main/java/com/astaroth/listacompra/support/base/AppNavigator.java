...
public final class AppNavigator {
	...
	public static final AppNavSetting NEW_TASK = new AppNavSettingsBuilder()
		.flags(FLAG_ACTIVITY_CLEAR_TASK | FLAG_ACTIVITY_NEW_TASK).build();
	...
	public static <T> void navigateTo(Class<T> activityClass, Context context, AppNavSetting navSetting) {
		...
		Bundle bundle =
			navSetting.animated ? makeCustomAnimation(context, android.R.anim.fade_in, android.R.anim.fade_out)
				.toBundle() : null;
	...
	public static class AppNavSetting {
		...
		public AppNavSettingsBuilder toBuild() {
			return new AppNavSettingsBuilder().extras(extras).flags(flags).animated(animated);
		}
